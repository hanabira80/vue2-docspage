    ...
    <div :class="{ 'px-2 py-4': $vuetify.breakpoint.xs, 'px-6 py-6': $vuetify.breakpoint.smAndUp }">
        ...
        <article class="mb-12">
            ...
            <div class="mt-6 pl-4">
                ...
                (2-2) PCD_RST_URL의 경로를 절대경로로 지정하면 PC, 모바일 모든 환경에서 다이렉트(현재창에서 바로 결제창을 호출) 방식을 사용할 수 있습니다.<br /><br />
            </div>
                ...
                <v-simple-table class="table-hover-disable">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td class="text-left pa-2" :class="[$vuetify.theme.dark ? 'table-high-light-bg-dm':'table-high-light-bg']" style="vertical-align:top">
                                <v-avatar rounded size="24" color="deep-purple accent-2" class="mr-2">
                                    <span class="white--text caption">
                                        권장
                                    </span>
                                </v-avatar>
                                <b>레이어팝업</b><br /><br />
                                PC환경에서 <span class="deep-purple--text font-weight-bold">범용적</span>으로 사용하는 방식입니다.
                            </td>
                            <td class="text-left pa-2" style="vertical-align:top">
                                <b>새탭(새창)</b><br /><br />
                                1. 모바일 환경설정에 <span class="deep-purple--text font-weight-bold">팝업차단 설정이 ON</span>되어 있으면 창이 열리지 않습니다.
                                <br /><br />
                        ...
                        <tr>
                            ...
                            <td class="text-left pa-2" style="vertical-align:top">
                                <b>다이렉트</b><br /><br />
                                보통 PC에서는 레이어팝업을 사용하기에 <span class="deep-purple--text font-weight-bold">고객에게 생소</span>할 수 있습니다
                            </td>
                            <td class="text-left pa-2" :class="[$vuetify.theme.dark ? 'table-high-light-bg-dm':'table-high-light-bg']" style="vertical-align:top">
                                <v-avatar rounded size="24" color="deep-purple accent-2" class="mr-2">
                                    <span class="white--text caption">
                                ...
                                <b>다이렉트</b><br /><br />
                                모바일 환경설정에 <span class="deep-purple--text font-weight-bold">팝업차단 설정이 ON되어 있어도 결제</span> 할 수 있습니다.
                            </td>
                        </tr>
                    </tbody>
                </v-simple-table>
            ...
            <div class="mt-12">
                <b>3. PCD_RST_URL / callbackFuntion 사용에 따른 기능 차이 </b>
            </div>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td colspan="1" rowspan="1" :class="[$vuetify.theme.dark ? 'table-high-light-bg-dm':'table-high-light-bg']">
                                <v-avatar rounded size="24" color="deep-purple accent-2">
                                    <span class="white--text caption">
                                        권장
                                    </span>
                                </v-avatar>
                        ...
                        <tr>
                            ...
                            <td colspan="1" rowspan="1">
                                PCD_RST_URL<br />
                                <span class="deep-purple--text font-weight-bold">(callback 무시)</span>
                            </td>
                            <td colspan="1" rowspan="1">
                                다이렉트
                            </td>
                        ...
                        <tr>
                            <td colspan="1" rowspan="1" 
                                :class="[$vuetify.theme.dark ? 'table-high-light-bg-dm':'table-high-light-bg']"
                                >
                                <v-avatar rounded size="24" color="deep-purple accent-2">
                                    <span class="white--text caption">
                                        권장
            ...
            <v-alert border="left" colored-border type="error" elevation="2" class="mt-6 mx-4">
                callback은 부모창을 따라가므로, 창이 갱신되는 다이렉트 방식에서는 부모창이 존재하지 않습니다.<br />
                따라서 다이렉트 방식에서는 callback을 설정해도 무시됩니다.
            </v-alert>
        </article>
    </div>
</template>
