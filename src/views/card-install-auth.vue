<template>
    <div :class="{ 'px-2 py-4': $vuetify.breakpoint.xs, 'px-6 py-6': $vuetify.breakpoint.smAndUp }">
        ...
        <article class="mb-12">
            <h2 class="" id="pay-regular-refuse">
                월 중복결제 방지기능 사용시
            ...
            <v-card class="temp_table ma-4 mb-12">
                <v-simple-table class="table-hover-disable">
                    <tbody>
                        ...
                        <tr>
                            <td colspan="1" rowspan="1">cst_id</td>
                            <td colspan="1" rowspan="1">String</td>
                            <td colspan="1" rowspan="1">8</td>
                            <td colspan="1" rowspan="1">O</td>
                            <td colspan="1" rowspan="1">test</td>
                            <td colspan="1" rowspan="1">가맹점 ID</td>
                        </tr>
                        <tr>
                            <td colspan="1" rowspan="1">custKey</td>
                            <td colspan="1" rowspan="1">String</td>
                            <td colspan="1" rowspan="1">255</td>
                            <td colspan="1" rowspan="1">O</td>
                            <td colspan="1" rowspan="1">abcd1234567890</td>
                            <td colspan="1" rowspan="1">가맹점 Key</td>
                        </tr>
                        <tr>
                            <td colspan="1" rowspan="1">PCD_PAY_WORK</td>
                            <td colspan="1" rowspan="1">String</td>
                            <td colspan="1" rowspan="1">20</td>
                            <td colspan="1" rowspan="1">O</td>
                            <td colspan="1" rowspan="1">LINKREG</td>
                ...
                <v-simple-table class="table-hover-disable">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td colspan="1" rowspan="1">
                                <a href="https://www.google.com/url?q=http://dev.testcpay.payple.kr/&amp;sa=D&amp;ust=1591934723292000">testcpay.payple.kr</a>
                            </td>
                            <td colspan="1" rowspan="1">
                                요청 URL
                            </td>
...
/* 
    ...
    */
    @ResponseBody
    @PostMapping(value = "/simplePayCard")
    public JSONObject payAuth() {
        JSONObject jsonObject = new JSONObject();
        JSONParser jsonParser = new JSONParser();
        try {
            ...
            String PCD_SIMPLE_FLAG = "Y";

            JSONObject obj = new JSONObject();
            obj.put("cst_id", cst_id);
            obj.put("custKey", cust_key);
            obj.put("PCD_PAY_TYPE", PCD_PAY_TYPE);
            obj.put("PCD_SIMPLE_FLAG", PCD_SIMPLE_FLAG);
...
/* 
    ...
    */
    @ResponseBody
    @PostMapping(value = "/regulerPayCard")
    public JSONObject payAuth() {
        JSONObject jsonObject = new JSONObject();
        JSONParser jsonParser = new JSONParser();
        try {
            ...
            String cust_key = "abcd1234567890";
            String PCD_PAY_TYPE = "card";
            String PCD_REGULER_FLAG = "Y";

            JSONObject obj = new JSONObject();
            obj.put("cst_id", cst_id);
            obj.put("custKey", cust_key);
            obj.put("PCD_PAY_TYPE", PCD_PAY_TYPE);
            obj.put("PCD_REGULER_FLAG", PCD_REGULER_FLAG);
    ...
    */
    ...
    public JSONObject payAuth() {
        ...
        try {
            ...
            String cst_id = "test";
            String cust_key = "abcd1234567890";
            String PCD_PAYCANCEL_FLAG = "Y";

            JSONObject obj = new JSONObject();
            obj.put("cst_id", cst_id);
            obj.put("custKey", cust_key);
            obj.put("PCD_PAYCANCEL_FLAG", PCD_PAYCANCEL_FLAG);
    ...
    */
    ...
    public JSONObject payAuth() {
        ...
        try {
            ...
            String cst_id = "test";
            String cust_key = "abcd1234567890";
            String PCD_PAYCHK_FLAG = "Y";

            JSONObject obj = new JSONObject();
            // 발급받은 비밀키. 유출에 주의하시기 바랍니다.
            obj.put("cst_id", cst_id);
            obj.put("custKey", cust_key);
            obj.put("PCD_PAYCHK_FLAG", PCD_PAYCHK_FLAG);
